...
color_3.pde和color_3.random.pde，随机数码颜色，没有colorString参数。
...
点击鼠标左键可以暂停，再点击鼠标左键恢复运行。点击鼠标右键保存图形。不点击鼠标，每画满一张图都自动保存一次。在控制台查看有关信息。从complementary.pde起，除了color_3.pde和color_3_random.pde，都可以按1键或2键看原图形与互补图形对比的效果。  
